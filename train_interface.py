...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    log_root_path = os.path.join("/home/qyx/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/evolution_tasks/logs"
...
def create_finished_folder(raw_path):
    """
    在最新日期-时间的文件夹中创建一个名为 'finished' 的文件夹。
...
if __name__ == "__main__":
    ...
    main()
    create_finished_folder("/home/qyx/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/evolution_tasks/logs/evolution_task")
    # close sim app
    
    simulation_app.close()
    time.sleep(5)
    # 发送信号表示仿真结束，在表示最新模型的文件夹下面创建一个tag文件
    # create_finished_folder("/home/qyx/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/evolution_tasks/logs/shadow_hand_stone_grdind")