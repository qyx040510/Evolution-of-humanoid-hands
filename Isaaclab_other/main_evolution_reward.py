...
evaluation_taks={"Isaac-EvolutionHand-Strike-v0"}
...
isaaclab_env_code_path =("/home/qyx/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/evolution_tasks/task_strike/evolution_strike_env_cfg.py"
                           )
